    ...
    <section className="team-section">
      ...
      <div className="team-section_saloon">
        ...
        <div className="team-section_saloon-cards">
          <TeamMemberCard
            ...
            linkedin={"https://www.linkedin.com/in/mohammad-zare-369z"}
            isActive={false}
          />
          <TeamMemberCard
          ...
          <TeamMemberCard
            ...
            job={"تیم سالن"}
            linkedin={
              "https://www.linkedin.com/in/mohammad-reza-arian-sefat-404a54282"
            }
          ...
          <TeamMemberCard
            name={"پارسا جوانشیر"}
            job={"تیم سالن"}
            photo={"/team/parsa-javanshir.webp"}
      ...
      <div className="team-section_scene">
        ...
        <div className="team-section_scene-cards">
          <TeamMemberCard
            ...
            isActive={false}
            linkedin={"https://www.linkedin.com/in/bardiya-rasekh-0a1bb11b7"}
          />
          <TeamMemberCard
            name={"محمد اقبال"}
            job={"مدیریت تیم صحنه"}
            ...
            isActive={false}
            linkedin={"https://www.linkedin.com/in/mohammad-eghbal-53b536253"}
          />
          <TeamMemberCard
            name={"مهدی ارمی"}
            job={"تیم صحنه"}
      ...
      <div className="team-section_reception">
        ...
        <div className="team-section_reception-cards">
          <TeamMemberCard
            linkedin={"https://www.linkedin.com/in/elham-feilizadeh-5b497521a/"}
      ...
      <div className="team-section_other">
        <h3 className="team-section_card-container_header">تیم پذیرش</h3>

        <div className="team-section_other-cards">
          <TeamMemberCard
            linkedin={"https://www.linkedin.com/in/mestersye/"}
            name={"احمدرضا رضایی"}
            job={"عکاس تیم"}
            photo={"/team/ahmadreza-rezaei.webp"}
            isActive={false}
          />
          <TeamMemberCard
            linkedin={"https://www.linkedin.com/in/parsa-shafiee/"}
            name={"پارسا شفیعی"}
            job={"پشتیبان"}
            photo={"/team/parsa-shafie.webp"}
            isActive={false}
          />
          <TeamMemberCard
            name={"ساناز نادری"}
